...
The repository is not yet public.
It still requires some polishing.
Stay tuned.
--
...
Currently, six simulated IoT devices are running back and forth between the cities of Baar and Zurich.
